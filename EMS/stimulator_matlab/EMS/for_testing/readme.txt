EMS MATLAB .NET Assembly (.NET Component)
...
EMS_overview.html - HTML overview documentation file for the generated component. It 
                    contains the requirements for accessing the component and for 
                    generating arguments using the MWArray class hierarchy.

EMS.xml - This file contains the code comments for the EMS component classes and methods. 
                    ...
                    documentation for the EMS component.
